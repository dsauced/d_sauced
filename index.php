...
<div id="wrapper">
	...
	<div id="header">
		...
		<div id="nav">
			<ul id="menu">
				<li><a href="index.php" rel="rl" rev="#d6d6d6">HOME</a></li>
				<li><a href="sports/index.php" rel="rl" rev="#BC5500">SPORTS</a></li>
				<li><a href="index3.php" rel="rl" rev="#BB8100">LOCAL</a></li>
				<li><a href="#" rel="rl" rev="#2A908E">PEOPLE</a></li>
				<li><a href="#" rel="rl" rev="#5C2381">SCENERY</a></li>
			</ul>
		</div>
	</div>
    ...
    $container.imagesLoaded(function(){
	 ...
	 $container.infinitescroll({
		...
		$(".box").click(function() {
			...
			$.fancybox({
				'href'				: $(this).children(".img").children("img").attr("src"),
				'width'				: 680,
			...
			//alert($(this).children(".img").children("img").attr("src"));
		});
...
<script type="text/javascript">
			$(function(){
				...
				$("#nav a:not(.revert)").bind("click",function(){
					var $this = $(this);
					$("#content").flip({
						direction: $this.attr("rel"),
						color: $this.attr("rev"),
						//content: function(){window.location = $this.attr("href"),//(new Date()).getTime(),},
						onAnimation: function(){
							$("body").css("background",$this.attr("rev"));
