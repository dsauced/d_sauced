...
<div id="wrapper">
	...
	<div id="header">
		<h1>Post-Gazette Sports Photos</h1>
		
		<div id="nav">
			<ul id="menu">
				<li><a href="../index.php" rel="rl" rev="#d6d6d6">HOME</a></li>
				<li><a href="index.php" rel="rl" rev="#BC5500">SPORTS</a></li>
				<li><a href="../index.php" rel="rl" rev="#BB8100">LOCAL</a></li>
	...
	<div id="content">
		<div class="box corner-stamp">
			<div class="img">
				<img class="lazy" src="sample-content/<?php echo rand(1, 11); ?>.jpg" width="230" alt="test" />
				</div>
		</div>
			...
			$(function(){
				...
				$("#nav a:not(.revert)").bind("click",function(){
					...
					$("#content").flip({
						...
						color: $this.attr("rev"),
						//content: $lo$this.attr("href"),//(new Date()).getTime(),
